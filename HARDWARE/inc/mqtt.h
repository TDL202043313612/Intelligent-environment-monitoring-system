...
#define  PRODUCTKEY           "grcx5IovPMD"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "kfb_test"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "c6bb5d8565accf85f6ec6c01cfcf223b"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/grcx5IovPMD/app_test/user/s_data"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/grcx5IovPMD/kfb_test/user/p_data"    //需要发布的主题     
